...
public class ConnectionProvider {
	...
	static UserBean fetchUserByUserId(UserBean user) throws IOException,ServletException {
	...
	static boolean	searchUser(UserBean user) throws IOException,ServletException {
